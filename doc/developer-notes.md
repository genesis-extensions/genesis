...
SafeCash is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as SafeCash, where everyone uses
...
pay attention to for reviewers of SafeCash code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: SafeCash uses tinyformat, which is type safe. Leave them out to avoid confusion
