...
Currently only `Source10` is used, for the example `genesis.conf` file.
...
matters for the `genesis-server` package. At this point, most RPM based
...
The `genesis-server` package should have SELinux support. How to properly do
