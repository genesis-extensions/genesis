...
# Source31 - what about safecash-tx and bench_bitcoin ???
...
The safecash-cli utility allows you to communicate and control a bitcoin daemon
...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 7234
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 7233
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 17234
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 17233
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 18443
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 27233
