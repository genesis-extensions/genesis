 ...
 */
class CGenesisAddress : public CBase58Data {
public:
    ...
    CGenesisAddress() {}
    CGenesisAddress(const CTxDestination &dest) { Set(dest); }
    CGenesisAddress(const std::string& strAddress) { SetString(strAddress); }
    CGenesisAddress(const char* pszAddress) { SetString(pszAddress); }
